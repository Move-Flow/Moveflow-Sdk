...
const IS_moveflow =
  window.location.hostname === 'app.moveflow.org' || window.location.hostname === 'staging.moveflow.org'
                ...
                <AutoRow>
                  <LinkWrapper>
                    <ExternalLink
                      ...
                      href={`https://github.com/moveflow/interface/issues/new?assignees=&labels=bug&body=${encodedBody}&title=${encodeURIComponent(
                  ...
                  <LinkWrapper>
                    <ExternalLink
                      ...
                      href="https://discord.com/invite/moveflow"
                      target="_blank"
                    >
                      <ThemedText.DeprecatedLink fontSize={16}>
