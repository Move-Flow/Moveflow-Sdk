...
describe('document', () => {
  describe('matchDocument', () => {
    const TEST_DOCUMENTS = [
      ...
      [{ request: {}, url: { hostname: 'app.moveflow.org', pathname: '' } }, false],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.moveflow.org', pathname: '' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.moveflow.org', pathname: '/#/swap' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.moveflow.org', pathname: '/asset.gif' } }, false],
